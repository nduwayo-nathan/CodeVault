...
barcode_image = "image.png"  # Update with your actual image path
...
java_command = [
    "java",
    "-cp",
    f"{javase_jar}:{core_jar}:{jcommander_jar}",  # Classpath for Linux (using colon separator)
    "com.google.zxing.client.j2se.CommandLineRunner",
    barcode_image  # Use the normal path, no file:// needed
]
